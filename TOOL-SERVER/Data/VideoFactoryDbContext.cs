...
public partial class VideoFactoryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ProviderRequest>(entity =>
        {
            ...
            entity.HasIndex(e => e.ParentProviderRequestId, "IX_ProviderRequests_Parent")
                .IsUnique()
                .HasFilter("([ParentProviderRequestId] IS NOT NULL AND [RequestKind] = 'TextRepair')");
            ...
            entity.Property(e => e.ErrorCode)
                ...
                .IsUnicode(false);
            entity.Property(e => e.ErrorMessage).HasMaxLength(4000);
            entity.Property(e => e.ErrorDetailsJson);
            entity.Property(e => e.EstimatedCost).HasColumnType("decimal(19, 6)");
            ...
            entity.HasOne(d => d.ParentProviderRequest).WithMany(p => p.RepairRequests)
                .HasForeignKey(d => d.ParentProviderRequestId)
                .OnDelete(DeleteBehavior.NoAction)
                .HasConstraintName("FK_ProviderRequests_ParentProviderRequest");
